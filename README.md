...
[![Version](https://img.shields.io/badge/version-1.12.29-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.12.29)
...
docker pull nubaeon/empirica:1.12.29-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.29

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.29 /bin/bash
```
</details>
