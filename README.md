...
[![Version](https://img.shields.io/badge/version-1.12.19-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.12.19)
...
docker pull nubaeon/empirica:1.12.19-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.19

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.19 /bin/bash
```
</details>
