...
[![Version](https://img.shields.io/badge/version-1.13.0-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.13.0)
...
docker pull nubaeon/empirica:1.13.0-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.13.0

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.13.0 /bin/bash
```
</details>
