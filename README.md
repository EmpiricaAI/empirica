...
[![Version](https://img.shields.io/badge/version-1.13.34-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.13.34)
...
docker pull nubaeon/empirica:1.13.34-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.13.34

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.13.34 /bin/bash
```
</details>
