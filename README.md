...
[![Version](https://img.shields.io/badge/version-1.12.35-blue)](https://github.com/EmpiricaAI/empirica/releases/tag/v1.12.35)
...
docker pull nubaeon/empirica:1.12.35-alpine

# Standard image (Debian slim, ~414MB)
docker pull nubaeon/empirica:1.12.35

# Run
docker run -it -v $(pwd)/.empirica:/data/.empirica nubaeon/empirica:1.12.35 /bin/bash
```
</details>
