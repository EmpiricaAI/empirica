...
**Status:** Shipped in 1.9.2 (proposal authored 2026-04-30, items 1–4 landed same week)
...
> Items 1–4 of the implementation ordering shipped on develop ahead of 1.9.2:
...
1. **Pause-actually-cancels-cron fix** — small, scoped,
   independently-valuable. Ship as 1.9.2 alongside the shell-construct
