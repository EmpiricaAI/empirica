...
**Fix (multi-part, landed across 1.8.15 + 1.9.2):**
...
`c389f6a06` (cortex sync from session row — 1.9.2), `27d76bc13`
(resolve_project_id raises — 1.9.2), `ec94dca1f` (grounded
verification CWD fix — 1.9.2). Tests in
