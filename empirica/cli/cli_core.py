        ...
        try:
            if isinstance(action, argparse._SubParsersAction):
                ...
                parts = [
                    ...
                    "    update-artifacts           Batch: fix wrong metadata (impact, provenance)\n",
                    ...
                    "    sources-check              Detect stale / broken sources\n",
                    "    source-update              Re-fetch + refresh a stale source\n",
                    "\n  Goals:\n",
...
def main(args=None):
    ...
    try:
        command_handlers = {
            ...
            "falsifier-list": handle_falsifier_list_command,
            ...
            "update-artifacts": handle_update_artifacts_command,
